...
const Footer = () => {
  return (
    <footer className="bg-racing-navy text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-300">
              The premier platform connecting racing teams with drivers and engineering talent.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/seats" className="text-sm text-gray-300 hover:text-white">
                  Race Seats
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/post-seat" className="text-sm text-gray-300 hover:text-white">
                  Post a Seat
                </Link>
              </li>
              <li>
